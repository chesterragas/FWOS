    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                      ...
                      "~/Content/assets/plugins/select2/dist/css/select2.min.css",
                      "~/Content/Site.css"));
            ...
            bundles.Add(new ScriptBundle("~/Content/js").Include(
                      ...
                      "~/Content/assets/plugins/bootstrap-sweetalert/sweetalert.min.js",
                      ...
                      "~/Content/assets/plugins/parsley/dist/parsley.js",
                      "~/Content/assets/plugins/highlight/highlight.common.js",
                      "~/Content/assets/js/demo/render.highlight.js",
                      ...
                      "~/Content/assets/js/demo/table-manage-responsive.demo.min.js",
                      "~/Content/assets/js/Sidebar.js",
                      "~/Content/assets/js/common.js",
                      "~/Content/assets/plugins/select2/dist/js/select2.min.js",
                      "~/Scripts/helper.js"));
